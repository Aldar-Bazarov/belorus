...
import type { DatePickerProps, RadioChangeEvent } from "antd/lib";
import {
  Typography,
  Select,
  Space,
...
const radioOptions = [
  { label: "Запись последнего месяца", value: "lastMonthRecord" },
  { label: "Запись с указанной даты", value: "selectedDateRecord" },
];

export const UpdateMBAL: React.FC = () => {
  ...
  const [radioValue, setRadioValue] = React.useState<string>("lastMonthRecord");
